...
#define DECLARE_MUTEX(HANDLE_NAME) Mutex_T* HANDLE_NAME
    ...
    extern int moveFile(char *oldFile, char *newFile);

    // Equivalent function for the systemcall 'cp'
    // the source file will be copied to destineation file
    extern int copyFile(char *sourceFile, char *destFile);
...
#define EXECDAEMON_PIPE "/var/execdaemon_pipe"
#define EXECDAEMON_REP "/var/execdaemon_rep"
