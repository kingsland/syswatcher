...
#define NCML_ERR_INVALID_INTERFACE_NAME                                0x87
...
extern int set_service_configurations(char *service_name, SERVICE_CONF_STRUCT* conf,int timeoutd_sess_timeout);
extern int create_service_defconf_file(void);
extern int check_service_conf_file(void);
extern int init_service_configurations(char *service_name, SERVICE_CONF_STRUCT* conf,int timeoutd_sess_timeout);
