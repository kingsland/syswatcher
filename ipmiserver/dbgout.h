...
/******************LOCAL2 TRAIL*************************/
#define TLOCAL2_LOG_FACILITY     ((LOG_LOCAL2))
...
#define PLATFORM_DBGOUTFN(n,fmt,args...)  
//IDBG_LINUXAPP_DbgOut(TDBG_AMI_APP_FACILITY | n,fmt,##args)
...
#define PLATFORM_LOCAL2OUTFN(n,fmt,args...)  IDBG_LINUXAPP_AuditOut(TLOCAL2_LOG_FACILITY | n,fmt,##args)
...
#define TINFO(fmt,args...)           PLATFORM_DBGOUTFN(LOG_INFO,fmt,##args)
#define TWARN(fmt,args...)           PLATFORM_DBGOUTFN(LOG_WARNING,TDBG_FILE_LINE_FMT fmt,TDBG_FILENAME,TDBG_LINENO,##args)
#define TWARN_1(fmt,args...)         PLATFORM_DBGLOGFN(LOG_WARNING,TDBG_FILE_LINE_FMT fmt,TDBG_FILENAME,TDBG_LINENO,##args)
#define TCRIT(fmt,args...)           PLATFORM_DBGOUTFN(LOG_CRIT,TDBG_FILE_LINE_FMT fmt,TDBG_FILENAME,TDBG_LINENO,##args)
#define TEMERG(fmt,args...)          PLATFORM_DBGOUTFN(LOG_EMERG,TDBG_FILE_LINE_FMT fmt,TDBG_FILENAME,TDBG_LINENO,##args)
#endif
#define TDBG_END
...
#define     TLOCAL2(level,fmt,args...)             PLATFORM_LOCAL2OUTFN(level, fmt, ##args)
#endif
