...
/*OEM LAN Configuration Commands*/
#define CMD_PERPARE_NODE_LAN_CONFIGURATION_PARAMETERS 	0x05
#define CMD_GET_NODE_LAN_CONFIGURATION_PARAMETERS		0x06
#define CMD_SET_NODE_LAN_CONFIGURATION_PARAMETERS		0x07
#define CMD_CHECK_PERPARE_READY							0x08
