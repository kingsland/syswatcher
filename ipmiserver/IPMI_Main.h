...
#define MSG_PIPES_PATH      "/opt/agent/run/"
#define NV_DIR_PATH			"/opt/agent/conf/BMC/"
#define SP_BIN_PATH         "/opt/agent/conf/"
#define MUTEX_PATH          "/opt/agent/run/"
#define DEFAULT_CONFIG_PATH	"/etc/defconfig/"
#define IPMI_PID_PATH "/opt/agent/run/IPMIPid"
...
/*OEM NODE LAN CFG TASK*/
#define NODE_LAN_CFG_Q			MSG_PIPES_PATH "NodeLanCfgQ"
#define NODE_SM_CFG_Q			MSG_PIPES_PATH "NodeSMCfgQ"
...
extern pthread_t gthreadIDs[50];
